...
export const componentMap: Record<string, any> = {
  ...
  Carousel: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.CarouselBlock),
  ),
  Dialog: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.DialogBlock),
  ),
  ImageNav: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.ImageNavBlock),
  ),
  Notice: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.NoticeBlock),
  ),
  Product: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.ProductBlock),
  ),
  RichText: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.RichTextBlock),
  ),
  Slider: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.SliderBlock),
  ),
  AssistLine: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.AssistLineBlock),
  ),
  FloatLayer: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.FloatLayerBlock),
  ),
  OnlineService: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.OnlineServiceBlock),
  ),
  CubeSelection: defineAsyncComponent(() =>
    import("@cms/ui").then((m) => m.CubeSelectionBlock),
  ),
...
export const configMap: Record<string, any> = {
  ...
  Dialog: defineAsyncComponent(
    () => import("../../../components/configs/DialogConfig.vue"),
  ),
  ImageNav: defineAsyncComponent(
    () => import("../../../components/configs/ImageNavConfig.vue"),
  ),
  Product: defineAsyncComponent(
    () => import("../../../components/configs/ProductConfig.vue"),
  ),
  RichText: defineAsyncComponent(
    () => import("../../../components/configs/RichTextConfig.vue"),
  ),
  Slider: defineAsyncComponent(
    () => import("../../../components/configs/SliderConfig.vue"),
  ),
  AssistLine: defineAsyncComponent(
