    ...
    <div class="config-section">
      ...
      <el-form label-position="top" size="small" class="space-y-4">
        <el-form-item label="背景颜色" class="mb-0">
          <div class="flex items-center gap-3">
            ...
            <span class="text-sm text-gray-500">
              {{
                draftProps.backgroundColor ||
                draftProps.defBackgroundColor ||
                "未设置"
              }}
            </span>
          </div>
        ...
        <el-form-item label="线条颜色" class="mb-0">
          <div class="flex items-center gap-3">
            <el-color-picker
              v-model="draftProps.borderColor"
              @change="handleUpdate"
            />
            <span class="text-sm text-gray-500">
              {{
    ...
    <div class="config-section">
      ...
      <div class="preview-container p-4 bg-gray-50 rounded-lg">
        <div
          ...
          :style="{
            backgroundColor:
              draftProps.backgroundColor || draftProps.defBackgroundColor,
